...
import SurveyOptions, { SurveyOption } from "../../../component/organism/surveyOptions/SurveyOptions";
...
const meta: Meta<typeof SurveyOptions> = {
  ...
  argTypes: {
    ...
    textMaxLength: { control: "number", defaultValue: 80, description: "Max characters for textbox" },
