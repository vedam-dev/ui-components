...
const hasActiveChild = hasSubmenu && item.submenu?.some((sub) => sub.selected === true || sub.id === activeId);
const isActive = item.selected || hasActiveChild || (!hasSubmenu && item.id === activeId);
            return (
