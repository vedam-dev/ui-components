    ...
    <TopBarContainer sx={sx}>
      ...
      <StudentInfo>
        ...
        <Box display="flex" alignItems="center" sx={{ gap: theme.spacing(3) }}>
          <IconButton onClick={onProfileClick} sx={{ padding: 0, backgroundColor: theme.palette.grey[600] }}>
            <Avatar src={studentPhoto} alt={studentName} sx={{ width: '48px', height: '48px', color: theme.palette.background.paper }}>
