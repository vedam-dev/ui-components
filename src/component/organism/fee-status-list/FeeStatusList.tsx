...
const FeeStatusList: React.FC<FeeStatusListProps> = ({ status, feeItems, onPayNow, ...props }) => {
  ...
  const iconGradientLight = theme.vd.palette.accentPrimaryLight;
  const iconGradientDark = theme.vd.palette.accentPrimary;
  const iconStrokeDark = theme.palette.primary[700];
  const iconStrokeLight = theme.palette.grey[50];
  const iconPathFill = theme.palette.grey[50];
      ...
      >
        ...
        >
          ...
          <defs>
            ...
            >
              <stop stopColor={iconGradientLight} />
              <stop offset="1" stopColor={iconGradientDark} />
            </linearGradient>
            <linearGradient
